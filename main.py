...
def main():
    ...
    while enemigos:
        ...
        continuar = input("¿Quíeres seguir explorando (s/n): ").lower()

        if continuar != "s":
            print("¡Gracias por haber jugado Batallass Galácticas!") 
            break

    if not enemigos:
        print("¡Felicidades has derrotado a todos los enemígos!")

if __name__ == "__main__": # nos asegura que solo podremos ejecutar eeste script desde el programa principal
    main()
